...
if __name__ == '__main__':
    ...
    path_save = sys.argv[2] if len(sys.argv) > 1 else './scripts/results/temporal_granularity'
    ...
    temporal_granularity_lst = ['8H', '1D', '7D']
    steps = 5
    ...
    for _ in range(steps):
        ...
        for temporal_granularity in temporal_granularity_lst:
            ...
            print(f'Train with {temporal_granularity} granularity...')
            ...
            res['temporal_granularity'] = temporal_granularity
        ...
        tmp = tmp.groupby(['temporal_granularity','model']).mean().reset_index()
        results.append(tmp)
