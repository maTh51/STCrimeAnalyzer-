...
def parse_args():
    ...
    parser.add_argument('--latdim', default=4, type=int, help='embedding size')
    ...
    parser.add_argument('--data', default='BH', type=str, help='name of dataset')
    ...
    parser.add_argument('--dropRateG', default=0.05, type=float, help='drop rate for global encoder')
    parser.add_argument('--device', type=str, default='cuda:0', help='cuda device')
    parser.add_argument('--tstEpoch', default=1, type=int, help='number of epoch to test while training')
    parser.add_argument('--save', type=str, default='./save/', help='save path')
    parser.add_argument('--checkpoint', type=str, default='./save/BH/', help='test path')
    parser.add_argument('--autotest', type=str, default=False, help='auto test or not')
    parser.add_argument('--config', type=str, default='./scripts/config.yaml', help='config file')
