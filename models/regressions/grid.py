...
shapefile_path = "/home/matheuspimenta/Jobs/PM/IC-CrimeAnalytics/API/layers/municipios-regioes/municipio.shp"
...
def set_points_to_grid(points, grid, column: str = "cell"):
    ...
    return gpd.sjoin(points, grid, predicate="within")["cell"]
