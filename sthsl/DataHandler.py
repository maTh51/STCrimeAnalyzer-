...
class DataHandler:
    def __init__(self, batch = 8, autotest = False):
        self.batch = batch
        if args.data == 'NYC':
            predir = 'data/NYC_crime/'
        elif args.data == 'CHI':
            predir = 'data/CHI_crime/'
        elif args.data == 'BH':
            predir = 'data/BH_crime/'
        else:
            predir = None
        if autotest:
            predir = f'{PATH}/data/BH_crime/auto_test/'
        ...
        args.decay_step = args.trnDays//self.batch
