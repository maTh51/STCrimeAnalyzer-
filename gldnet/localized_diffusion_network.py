...
class LocalizedDiffusionNetwork(tf.keras.Model):
    def __init__(self, lname, transition_matrix, num_ldn_layers=5, ldn_hidden_units_per_layer=4, hidden_units=4,**kwargs):
        super(LocalizedDiffusionNetwork, self).__init__(name=lname, **kwargs)
